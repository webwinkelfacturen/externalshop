...
class addOrderErrorTotalsInclExcl extends \PHPUnit\Framework\TestCase {
   ...
   /**
     ...
     */
    public function testAddOrderNoSyncInclExl(array $parms): void
    {
        ...
        $this->assertTrue($result['errorcode']     == 'ORD101_TOTALS_NOMATCH');
        $this->assertTrue($result['errormessage']  == 'The sum of the ordertotals excl, incl and vat do not match');
        $this->assertTrue(strpos($result['specification'], 'Fields concerned are totalInclWithDiscount, totalExclWithDiscount, totalVatWithDiscount') !== false);
    }
